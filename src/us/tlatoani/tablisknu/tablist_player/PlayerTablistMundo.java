    ...
    public static void load() {
        Registration.registerEffect(EffShowHidePlayerTab.class,
                ...
                .document("Show or Hide in Tablist", "1.0",
                        "Shows or hides certain players in the specified or all tablist(s). "
                        + "Note: if the Players Are Visible condition/expression is set to false in a certain tablist "
                        + "and you show a player in that tablist using this effect, "
        ...
        Registration.registerEffect(EffClearPlayerModifications.class,
                ...
                .document("Clear Player Tab Modifications", "1.0",
                        "Resets all of the tabs representing players in the specified or all tablist(s) to normal. "
                        + "This will make all players visible in the tablist(s) "
                        + "and reset any display name, latency, and score changes.");
        Registration.registerExpression(ExprDisplayNameOfPlayerTab.class, String.class, ExpressionType.PROPERTY,
                ...
                .document("Display Name of Player Tab", "1.0",
                        "An expression for the display name of the specified player tab in the specified or all tablist(s). "
        ...
        Registration.registerExpression(ExprLatencyBarsOfPlayerTab.class, Number.class, ExpressionType.PROPERTY,
                ...
                .document("Latency Bars of Player Tab", "1.0",
                        "An expression for the amount of latency bars of the specified player tab in the specified or all tablist(s). "
        ...
        Registration.registerExpression(ExprScoreOfPlayerTab.class, Number.class, ExpressionType.PROPERTY,
                ...
                .document("Score of Player Tab", "1.0",
                        "An expression for the score of the specified player tab in the specified or all tablist(s). "
        ...
        Registration.registerExpressionCondition(CondPlayerTabIsVisible.class, ExpressionType.COMBINED,
                ...
                .document("Player Tab is Visible", "1.0",
                        "Checks whether the first player's tab is visible in the specified or all tablist(s). ");
        Registration.registerExpressionCondition(CondPlayerTabsAreVisible.class, ExpressionType.PROPERTY,
                ...
                .document("Player Tabs Are Visible", "1.0",
                        "Checks whether the specified or all tablist(s) allow player tabs to be visible. "
                        + "Setting this to false prevents any player tabs from being seen in the specified or all tablist(s) "
                        + "(players who join will be automatically hidden). "
                        + "Setting this to true immediately makes all player tabs visible in the specified or all tablist(s). "
