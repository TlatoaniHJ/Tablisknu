...
public abstract class TablistProvider {
     ...
     * For a list of players the returned {@link Stream} will contain all of the players,
    ...
    /**
     * Returns an {@link Iterable} that will contain all tablists pertaining to this TablistProvider.
     */
    public abstract Iterable<Tablist> get(Event event);
    ...
    private static class Players extends TablistProvider {
        ...
        public Stream<Tablist> view(Event event) {
            return Stream.of(expression.getArray(event)).map(TablistManager::getTablistOfPlayer);
        }
    ...
    private static class Group extends TablistProvider {
        ...
        public Iterable<Tablist> get(Event event) {
            ...
            return getGroup(event).<Iterable<Tablist>>map(Function.identity()).orElse(Collections.emptySet());
        }
